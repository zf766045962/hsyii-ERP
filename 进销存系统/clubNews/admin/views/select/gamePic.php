    ...
    <div class="material c">
        <div class="material-lt">
            ...
            <div class="material-pic c">
                <ul id="material-main" class="c">
                    ...
                    <li>
                        <div class="pic"><a href="<?php echo $v->v_file_path;?><?php echo $v->v_pic;?>" target="_blank"><img src="<?php echo $v->v_file_path;?><?php echo $v->v_pic;?>"></a></div>
                        <div class="title">
        ...
        <div class="material-rt">
            <div class="material-group">
                ...
                <a<?php if($group_id==$v->id){?> class="current"<?php }?> href="<?php echo $this->createUrl('gfMaterial/'.$action, array('group_id'=>$v->id));?>"><?php echo $v->group_name;?><span>(<?php echo GfMaterial::model()->getNum($v->id,252);?>)</span></a>
                <?php } ?>
            </div>
