<div class="box">
      <div class="box-content">
        <div class="box-header">
            <a class="btn" href="<?php echo $this->createUrl('create');?>"><i class="fa fa-plus"></i>销售开单订单登记</a>
            ...
            <table class="list">
                <thead>
                    <tr>
                        ...
                        <th><?php echo $model->getAttributeLabel('customer_name');?></th>
                        <th><?php echo $model->getAttributeLabel('receiver');?></th>
                        <th><?php echo $model->getAttributeLabel('auditor');?></th>
                ...
                <tbody>
                    ...
                    <tr>    
                        ...
                        <td><?php echo CHtml::link($v->order_title, array('update', 'id'=>$v->id)); ?></td>
