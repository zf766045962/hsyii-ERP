...
// 如果设置了$PHPSESSID，就将SessionID赋值为$PHPSESSID，否则生成SessionID  
 ...
 //$arr= $p_lategate->get_list($d1,$d1);
  ...
  $st2= Sclass::model()->find("STSNUM=".$_SESSION['usercode'].' and scterm=2');
?>
  ...
  <ion-scroll  direction="y" scrollbar-y="false" style="width: 100%; height: 100%">
    ...
    <form id="data_form">
     ...
     <table  width="100%" border="0" cellspacing="0" cellpadding="0" style="background:#FFF7EA;">
       ...
       <th width="18%" style="height:30px; font-size:12px;"><?php echo  $st2->sclev;?></th>
       <th width="15%"  style="font-size:12px" >班別</th>
      <th width="18%"  style="height:30px; font-size:12px;" ><?php echo  $st2->scclass;?></th>
      <th width="15%" style="font-size:12px">學號：</th>
      <th width="18%" style="height:30px; font-size:12px;"><?php echo $st2->scsnum;?></th>
      </tr>
    </table>
  <table  width="100%" border="0" cellspacing="0" cellpadding="0" style="background:#FFF7EA;" >
    <tr><th width="100%"  >
